...
function inicia(){
   ...
   menuLateral='';
   menuActividades='<h1>MAS ACTIVIDADES</h1><a href=\"javascript:irA(0)\" title=\"CARTILLA 2 SOY GESTOR DE PAZ\">1 </a><a href=\"javascript:irA(1)\" title=\"RELACION PALABRAS\">2 </a><a href=\"javascript:irA(2)\" title=\"BUSCAR PAREJAS PALABRAS\">3 </a>';
...
taboaContidos[0]=new act("CARTILLA 2 SOY GESTOR DE PAZ","CARTILLA 2 SOY GESTOR DE PAZ","","<object width='100%' height='800' type='text/html' data='CARTLLA2/CARTLLA2.htm'></object>",true,"",true,true,true);
taboaContidos[1]=new act("RELACION PALABRAS","RELACION PALABRAS","","<object width='100%' height='720' type='text/html' data='CART2_RELACION/CART2_RELACION.htm'></object>",true,"",true,false,false);
taboaContidos[2]=new act("BUSCAR PAREJAS PALABRAS","BUSCAR PAREJAS PALABRAS","","<object width='100%' height='720' type='text/html' data='PAREJAC2/PAREJAC2.htm'></object>",true,"",true,false,false);
