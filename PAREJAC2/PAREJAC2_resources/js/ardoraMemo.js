...
$("#ardoraAct").not(this).animate({opacity:1},4000);}
function isCorrect(){
...
$("#p"+open1R.toString()+open1C.toString()).not(this).animate({opacity:0},3000);$("#ima"+open1R+open1C+"_img").not(this).animate({opacity:1},3000);
$("#p"+open2R.toString()+open2C.toString()).not(this).animate({opacity:0},4000); $("#ima"+open2R+open2C+"_img").not(this).animate({opacity:1},4000);}$("#ima"+open1R+open1C).css("border-color",colorText);
